...
export default function AdminDashboard() {
  return (  
    <Container fluid className="p-4" style={{ backgroundColor: "#f9fafa"}}>
      ...
      <Row className="mb-4">
        {cardData.map((card, index) => (
          <Col md={2} xs={6} key={index} className="mb-3 " >
            ...
            >
              <Card className="adminDashboard-summary-card shadow-sm text-center p-2 border-0 rounded-4" >
      ...
      <Row className="mt-3">
        <Col md={6} className="mb-3">
          <Card className="shadow-sm text-center border-0 rounded-4" style={{ backgroundColor: "#EEEFE0"}}>
            <Card.Body>
