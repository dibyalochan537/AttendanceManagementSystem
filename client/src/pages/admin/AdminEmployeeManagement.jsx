...
const AdminEmployeeManagement = () => {
  ...
  const handleAddEmployee = (e) => {
    ...
    const newEmp = {
      ...
      empStatus: form.empStatus.value,
    };
  ...
  <Form onSubmit={handleAddEmployee}>
    ...
    <Modal.Body>
      ...
      <Form.Group className="mb-3" controlId="formAddempStatus">
        <Form.Label>Employee Status</Form.Label>
        <Form.Select name="empStatus" required>
          <option value="">Select EmpStatus</option>
        ...
        {currentEmp && (
          <Form onSubmit={handleEditEmployee}>
            ...
            <Modal.Body>
              ...
              <Form.Group className="mb-3" controlId="formEditempStatus">
                <Form.Label>Employee Status</Form.Label>
                <Form.Select name="empStatus" required>
                  <option value="">{currentEmp.empStatus}</option>
                  <option value="active">active</option>
                  <option value="inactive">inActive</option>
                </Form.Select>
              </Form.Group>
